...
<script>
	function zf(){
		layer.msg("支付成功！");
		setTimeout(function(){
			window.location.href="bookMain.do";
		},2000);
	}
</script>
<body>
  ...
  <div class="main">
	...
	<div class="order_state">
    	<div class="opr_order">
            ...
            <div class="state_btn">
                <ul>
                	<li><a href="javascript:zf()">支付</a></li>
        ...
        <div id="order_text_1">
        	<div class="order_text_2">
				...
				<ul>
                	...
                	<li>地    址：北京昌平区</li>
               		<li>固定电话：123456</li>
                	<li>手机号码：88888888888</li>
                	<li>电子邮件：327996122@qq.com</li>
                </ul>
            </div>
            <div class="order_text_2">
                <b>支付及配送方式</b>
				<ul>
                	<li>支付方式：邮局汇款</li>
                	<li>运    费：￥0.00</li>
               		<li>送货日期：只双休日、假日送货（工作日不用送）：15810327686</li>
