...
public class Product implements Serializable{
	...
	private Timestamp print_time; // 印刷时间
	...
	public Product(int product_id, String name, String keywords, Timestamp add_time, String picture, String big_picture,
				   double fixed_price, double lower_price, String description, String author, String publishing,
				   Timestamp publish_time, String isbn, String language, String which_edtion, String total_page,
				   String bind_layout, String book_size, String editor_description, String catalog, String book_summary,
				   String author_summary, String extracts, Timestamp print_time, int print_number, String paper_type,
	...
	public String toString() {
		return "Product [product_id=" + product_id + ", name=" + name + ", keywords=" + keywords + ", add_time="
